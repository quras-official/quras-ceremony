...
namespace Ceremony.Core
{
    public class SeedInfoTransaction
    {
        ...
        public void CreateSeedSignature(byte[] privateKey, ECPoint senderPubkey, ECPoint XORSeed, ECPoint MySeed)
        {
            Signature1 = senderPubkey * privateKey + XORSeed;
            Signature2 = senderPubkey * privateKey + MySeed;
        }
