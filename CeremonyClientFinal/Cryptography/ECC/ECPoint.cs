...
namespace Ceremony.Cryptography.ECC
{
    public class ECPoint : IComparable<ECPoint>, IEquatable<ECPoint>, ISerializable
    {
        ...
        /// </summary>
        /// <param name="encoded">The byte array to be decoded</param>
        /// <param name="curve">Curve parameter</param>
        /// <returns></returns>
        ...
        /// <param name="curve">Elliptic curve parameter</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="commpressed">Whether it is a compression format encoding</param>
        ...
        /// <summary>   
        /// Parse the public key from the specified byte array, which can be any form of public key encoding, or contain the contents of the private key
        /// </summary>
        /// <param name="pubkey">The byte array to parse</param>
        /// <param name="curve">Elliptic curve parameter</param>
        ...
        /// Get HashCode
        /// </summary>
        /// <returns>Return to HashCode</returns>
        ...
        public static ECPoint operator *(ECPoint p, byte[] n)
        {
            ...
            if (p.IsInfinity)
                return p;
            //BigInteger's memory cannot be protected and there may be security risks. Here k needs to override a SecureBigInteger class instead
